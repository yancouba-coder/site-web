...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/ge_formats.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/ge_formats.js":
/*!********************************************!*\
  !*** ./app/javascript/packs/ge_formats.js ***!
  \********************************************/
/*! no exports provided */
...
var libelle_container = jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#libelle");
var sections_container = jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#sections");
var json = JSON.parse(jquery__WEBPACK_IMPORTED_MODULE_0___default()("p#mydata").html());
var tmp_json = 1;
...
function add_input_to_parent(key, parent, i) {
  ...
  newCloseButton.onclick = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#' + i).remove();
  };
...
function add_section_to_parent(data, section_id, parent) {
  ...
  newDeleteSectionButton.onclick = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div#' + 'section' + section_id).remove();
  };
  ...
  var _loop = function _loop(i) {
    ...
    newCloseButtonChoice.onclick = function () {
      for (var _i6 = 0; _i6 < json['sections'].length; _i6++) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#section" + _i6).remove();
      }
  ...
  newAddChoixButton.onclick = function () {
    for (var _i = 0; _i < json['sections'].length; _i++) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#section" + _i).remove();
    }
  ...
  var _loop2 = function _loop2(_i3) {
    ...
    newCloseButtonChoice.onclick = function () {
      for (var _i8 = 0; _i8 < json['sections'].length; _i8++) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#section" + _i8).remove();
      }
  ...
  newAddButtonCompetences.onclick = function () {
    for (var _i4 = 0; _i4 < json['sections'].length; _i4++) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("div#section" + _i4).remove();
    }
...
function send_json() {
  ...
  var url = jquery__WEBPACK_IMPORTED_MODULE_0___default()('button#send_button').val();
...
function main() {
  ...
  for (var key in json) {
    switch (key) {
      case 'commentaire':
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#commentaire').attr("checked", "checked");
        break;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  return jquery__WEBPACK_IMPORTED_MODULE_0___default()('button#add_label_button').on('click', function () {
    return add_label();
  });
}, jquery__WEBPACK_IMPORTED_MODULE_0___default()('button#send_button').on('click', function () {
  return send_json();
}), jquery__WEBPACK_IMPORTED_MODULE_0___default()('button#add_section_button').on('click', function () {
  return add_section();
}), jquery__WEBPACK_IMPORTED_MODULE_0___default()('input#commentaire').on('change', function () {
  return commentaire_manager();
}));
jquery__WEBPACK_IMPORTED_MODULE_0___default()('select#ver').change(function () {
  window.location.replace(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
});
...
/******/ });
//# sourceMappingURL=ge_formats-a6a27adee833f16fcc59.js.map